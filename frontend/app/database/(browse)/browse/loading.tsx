          ...
          <div className="bg-white py-3 px-6 rounded-md mb-2">
            ...
            <div className="flex flex-wrap gap-2">
              {[...Array(8)].map((_, i) => (
                <div
                  key={i}
                  className="h-7 w-20 bg-[color:var(--section-accent)]/25 rounded-none"
                />
              ))}
            </div>
          </div>
            ...
            <div key={i} className="block w-full">
              <div className="bg-white p-4 rounded-lg">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                  {/* Artist Name */}
                  <div className="h-8 w-1/2 bg-[color:var(--section-accent)]/25 rounded mb-2 sm:mb-0" />
                  {/* Categories */}
                  <div className="flex gap-2 w-1/3">
                    {[...Array(2)].map((_, j) => (
                      <div
                        key={j}
                        className="h-6 w-20 bg-[color:var(--section-accent)]/25 rounded-none"
                      />
                    ))}
                  </div>
                  {/* Tags */}
