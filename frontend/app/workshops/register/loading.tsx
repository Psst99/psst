export default function Loading() {
  return (
    <div className="h-full w-full md:max-w-[65vw] mx-auto mt-6 px-6">
      {/* Title */}
      <div className="h-10 w-2/3 mx-auto mb-6 mt-0 md:mt-0 bg-[color:var(--section-accent)]/30 rounded" />
      {/* Description */}
      ...
      <div className="mt-16 space-y-4 mx-auto">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="h-12 bg-[color:var(--section-accent)]/30 rounded" />
        ))}
        {/* Submit button */}
