export default function Loading() {
  return (
    <div className="animate-pulse">
      {/* Calendar skeleton */}
      <div className="pt-0 p-2 sm:p-4 rounded-lg h-[80svh] w-full md:max-w-[85vw] mx-auto flex flex-col">
        ...
        <div className="mt-2 flex items-center justify-between gap-2 h-6 text-base leading-tight md:text-xl tracking-tight shrink-0">
          <div className="bg-[color:var(--section-accent)]/40 px-2 sm:px-4 py-1 rounded-md flex items-center h-full w-12" />
