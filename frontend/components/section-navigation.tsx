    ...
    <div className='w-full'>
      ...
      <div className='flex relative w-full'>
        <CustomLink
          ...
          style={
            currentSection === 'psst'
              ? { '--underline-color': SECTION_COLORS.psst }
              : {}
          }
        >
          Psst
      ...
      ${currentSection === 'database' ? 'z-20 section-underline' : 'z-10'}
          ...
          style={
            currentSection === 'database'
              ? { '--underline-color': SECTION_COLORS.database }
              : {}
          }
        >
          Database
        ...
        <CustomLink
          ...
          style={
            currentSection === 'workshops'
              ? { '--underline-color': SECTION_COLORS.workshops }
              : {}
          }
        >
          Workshops
        ...
        <CustomLink
          ...
          style={
            currentSection === 'events'
              ? { '--underline-color': SECTION_COLORS.events }
              : {}
          }
        >
          Events
        ...
        <CustomLink
          ...
          style={
            currentSection === 'resources'
              ? { '--underline-color': SECTION_COLORS.resources }
              : {}
          }
        >
          Resources
        ...
        <CustomLink
          ...
          style={
            currentSection === 'archive'
              ? { '--underline-color': SECTION_COLORS.archive }
              : {}
          }
        >
          Archive
