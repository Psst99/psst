  ...
  return (
    <div className='p-4 h-full'>
      <form className='space-y-4' onSubmit={handleSubmit}>
            ...
            {['feminist', 'queer', 'racial', 'disability'].map((key) => (
              <label key={key} className='flex items-center gap-1'>
                <input
                  ...
                  onChange={(e) => handlePoliticalChange(key, e.target.checked)}
          ...
          <div className='flex flex-col gap-2'>
            ...
            <label className='flex items-center gap-2'>
              ...
              <input
                ...
                onChange={(e) => handlePoliticalChange('other', e.target.value)}
                className='rounded px-2 py-1 text-[#07f25b] border-0 outline-0'
              />
            </label>
          </div>
        ...
        <div className='w-full bg-[#07f25b] text-[#81520A] rounded-lg mb-6 md:flex md:items-center md:justify-center'>
          <label className='block text-[#81520A] font-medium text-center uppercase font-mono p-0 md:w-[30%]'>
            Have you thought of and applied a wage policy which is fair between
            all participants? Please detail with transparency:
          </label>
          <textarea
          ...
          <div className='flex flex-col gap-2'>
            ...
            <label className='flex items-center gap-2'>
              ...
              <span className='font-mono'>
                ...
                build-down and return of the system (it’s heavy and fragile).
              </span>
            </label>
            <label className='flex items-center gap-2'>
              <input
