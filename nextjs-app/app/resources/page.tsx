export default function ResourcesPage() {
  return (
    <div className='p-4 text-[#1D53FF]'>
      <h1 className='text-3xl md:text-4xl mb-6 text-center'>Resources</h1>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4 max-w-5xl mx-auto'>
        ...
        <div className='bg-white p-4 sm:p-6 rounded-lg'>
          <h2 className='text-4xl md:text-3xl mb-2 text-[#1D53FF]'>Admin</h2>

          <span className='bg-[#1D53FF] text-white px-1 py-0 text-sm font-mono'>
            12-03-2024
          </span>
          <span
        ...
        <div className='bg-white p-4 sm:p-6 rounded-lg'>
          ...
          <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0'>
            <span className='text-[#1D53FF] font-bold'>July 8, 2023</span>
            <button className='bg-[#1D53FF] text-white px-4 py-1 font-bold w-full sm:w-auto'>
              REGISTER
            </button>
          </div>
        </div>
        ...
        <div className='bg-white p-4 sm:p-6 rounded-lg'>
          ...
          <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0'>
            <span className='text-[#1D53FF] font-bold'>July 22, 2023</span>
            <button className='bg-[#1D53FF] text-white px-4 py-1 font-bold w-full sm:w-auto'>
              REGISTER
            </button>
          </div>
        ...
        <div className='bg-white p-4 sm:p-6 rounded-lg'>
          ...
          <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0'>
            <span className='text-[#1D53FF] font-bold'>August 5, 2023</span>
            <button className='bg-[#1D53FF] text-white px-4 py-1 font-bold w-full sm:w-auto'>
              REGISTER
            </button>
          </div>
