export default function WorkshopsPage() {
  return (
    <div className='p-4 text-[#f50806]'>
      <h1 className='text-3xl md:text-4xl mb-6 text-center '>Workshops</h1>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4 max-w-5xl mx-auto'>
        ...
        <div className='bg-white p-4 sm:p-6 rounded-lg'>
          <h2 className='text-4xl md:text-3xl mb-2 text-[#f50806]'>Admin</h2>

          <span className='bg-[#f50806] text-white px-1 py-0 text-sm font-mono'>
            12-03-2024
          </span>
          <span
